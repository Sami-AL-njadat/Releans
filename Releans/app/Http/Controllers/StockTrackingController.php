...
class StockTrackingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($newProduct->quantity <= $newProduct->minimum_level) {
            ...
            // Ensure inventory status is updated to 'normal' if above minimum level
    ...
    public function allTran()
    {
        ...
        if ($stock->isEmpty()) {
            ...
            $formattedStock = $stock->map(function ($item) {
                ...
                return [
                    'product_name' => $product->name, // Assuming you want to get the name of the product
                    'quantity' => $product->quantity, // Assuming you want to include the quantity from stockTracking
                ];
            });
