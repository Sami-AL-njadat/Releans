...
@section('content')
 ...
 <span class="badge badge-${badgeColor}">${product.status}  <img style="hight:110px; width:200px ;border-radius:50%" src="${product.image}" class="img-fluid" alt="Product Image"></span>
                         <h6 style="padding:7px" class="card-text">Price: ${product.price}</h6>
