             ...
             <!-- Your HTML code with the dropdown menu -->

             {{-- <script>
                 // Fetch notifications using JavaScript Fetch API
                 fetch('http://127.0.0.1:8000/api/notifications')
                     .then(response => response.json())
                     .then(data => {
                         if (data.status === 200) {
                             const notifications = data.inventory;
                             const dropdownContent = document.querySelector('.dropdown-list-content');
                             ...
                             notifications.forEach(notification => {
                                 ...
                                 listItem.classList.add('dropdown-item-unread');
                                 listItem.innerHTML = `
                        <div class="dropdown-item-icon bg-primary text-white">
                            <i class="fas fa-code"></i>
                        </div>
                        <div class="dropdown-item-desc">
                            ${notification.id} is low in stock!
