   <div class="main-sidebar sidebar-style-2">
       <aside id="sidebar-wrapper">
           ...
           <ul class="sidebar-menu">
               ...
               <li><a class="nav-link" href="{{ route('product.page') }}"><i class="far fa-square"></i> <span>Product
                           Page</span></a>
               </li>
               <li><a class="nav-link" href="{{ route('stock.page') }}"><i class="far fa-square"></i> <span>Stock
                           Page</span></a></li>
               <li class="dropdown">
