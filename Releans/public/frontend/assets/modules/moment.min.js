!(function (e, t) {
    ...
    function v(t, n) {
        ...
        return u(function () {
            if (
                (null != e.deprecationHandler && e.deprecationHandler(null, t),
                    s)
            ) {
    ...
    function Z(e, t) {
        ...
        return (
            (e += (t - n) / 12), 1 === n ? (E(e) ? 29 : 28) : 31 - ((n % 7) % 2)
        );
    }
    function z(e, t) {
        var n;
        ...
        if (t._f !== e.ISO_8601)
            if (t._f !== e.RFC_2822) {
                ...
                var n,
                    ...
                    l = 0;
                for (
                    i = R(t._f, t._locale).match(rt) || [], n = 0;
                    n < i.length;
                    n++
                )
                    (r = i[n]),
    ...
    function Ye(t, n) {
        ...
        return n._isUTC
            ? ((s = n.clone()),
                (i =
                    (_(t) || r(t) ? t.valueOf() : pe(t).valueOf()) - s.valueOf()),
        ...
        (Dn.isDSTShifted = v(
            ...
            function () {
                ...
                if ((f(e, this), (e = ye(e))._a)) {
                    ...
                    this._isDSTShifted =
                        this.isValid() && p(e._a, t.toArray()) > 0;
        ...
        (kn.months = function (e, n) {
            return e
                ? t(this._months)
                    ...
                    : this._months[
                    (this._months.isFormat || Nt).test(n)
                        ? "format"
                        : "standalone"
                    ][e.month()]
                : t(this._months)
        ...
        (kn.monthsShort = function (e, n) {
            return e
                ? t(this._monthsShort)
                    ...
                    : this._monthsShort[Nt.test(n) ? "format" : "standalone"][
                    e.month()
                    ]
                : t(this._monthsShort)
                    ? this._monthsShort
        ...
        (kn.weekdays = function (e, n) {
            return e
                ? t(this._weekdays)
                    ...
                    : this._weekdays[
                    this._weekdays.isFormat.test(n)
                        ? "format"
                        : "standalone"
                    ][e.day()]
                : t(this._weekdays)
